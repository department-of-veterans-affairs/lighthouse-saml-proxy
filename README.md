...
This is a hybrid JavaScript/Typescript application. Our former goal is eventually have it be completely written in Typescript, therefore all new features should be written in TypeScript and have an accompanying test written using Jest. 
